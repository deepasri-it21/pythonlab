...
filepath = 'D:\New folder (2)\Plant-Leaf-Disease-Prediction-main'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('D:\New folder (2)\Plant-Leaf-Disease-Prediction-main\Dataset\test/Tomato___Bacterial_spot (1).JPG')
